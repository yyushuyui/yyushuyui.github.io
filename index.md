...
- **LLM Safety and Ethics:** safety under jailbreak attack scenarios; regulatory compliance of LLM outputs; bias and prejudice in model behavior
- **Personalized NLP:** how LLM outputs vary in style, and how to model individual user preferences over such outputs
- **LLM Post-training Analysis:** the broader effects and value of post-training methods (SFT/DPO/RLHF/RLVR) on model behavior
